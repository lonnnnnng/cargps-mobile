...
- [剩余高风险迁移项](./migration-risks.md)：M1-M7 落地证据、本轮存储与生命周期 seam 复验、API 27/29 正式旧包升级、跨 API 完整权限矩阵、API 27/29/35 30 分钟回归和 API 27 整机重启边界结论，以及低存储、尾批、真实 Service 异常竞态、最终候选、真机长测、开机自动恢复评审和 AGP 9 的剩余顺序与验收门槛。
